...
export default function Grid({gameMatrix, onStart,curScore,justGenerated, justMergedMatrix, setGameMatrix, setCurrentScore, isGameOver, setIsGameOver}:gridProps) {
